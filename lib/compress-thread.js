...
(async () => {
  ...
  if (command.type === 'compressUsingBestFormat') {
    result = await compressUsingBestFormat(command.args)
  } else if (command.type === 'compress') {
    result = await compress(command.args)
  } else if (command.type === 'compressToSsim') {
    result = await compressToSsim(command.args)
  }
